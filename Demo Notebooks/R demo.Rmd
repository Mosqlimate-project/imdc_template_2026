...
**Tenho que conferir depois se essa tabela bate com o que está na implementação da função:**  
...
You only need to fill out the geographic level your model specifically targets. Leave the others as null. E
